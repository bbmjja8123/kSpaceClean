...
public struct ControlWidgetView: View {
    ...
    public var body: some View {
        // The whole widget tap-target routes to `kmonitor://open`, which the
        // main app's `handleDeepLink` turns into "open the Dashboard window
        // and bring kMonitor to the foreground". Works on macOS 13+ without
        ...
        .widgetURL(URL(string: "kmonitor://open"))
    }
}
