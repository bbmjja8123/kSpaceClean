...
/// Free intent. Tells kMonitor to start continuous metric sampling.
@available(macOS 13.0, *)
public struct StartMonitoringIntent: AppIntent {
    public static var title: LocalizedStringResource = "Start kMonitor Monitoring"
    ...
    public func perform() async throws -> some IntentResult & ProvidesDialog {
        ...
        return .result(dialog: IntentDialog("kMonitor monitoring started."))
    }
}