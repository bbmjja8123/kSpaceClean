...
/// Owns the Core Data container used by kMonitor persistence repositories.
///
/// The managed object model is created programmatically so the kMonitor target
...
public final class CoreDataStack: @unchecked Sendable {
    ...
    public init(inMemory: Bool = false, appGroupIdentifier: String? = nil) throws {
        ...
        container = NSPersistentContainer(name: "kMonitor", managedObjectModel: model)
        ...
        if inMemory {
            ...
            let storeURL = groupURL.appendingPathComponent("kMonitor.sqlite")
