...
/// Preferences that may be read and updated by kMonitor presentation layers.
...
public final class PreferencesRepository: PreferencesRepositoryProtocol, @unchecked Sendable {
    ...
    private static let menuBarModeKey = "kMonitor.menuBarMode"
    private static let enabledKindsKey = "kMonitor.enabledKinds"
    private static let samplingIntervalKey = "kMonitor.samplingIntervalSeconds"
    private static let onboardingCompletedKey = "kMonitor.onboardingCompleted"
    private static let launchAtLoginKey = "kMonitor.launchAtLogin"
    private static let menuBarIconThemeKey = "kMonitor.menuBarIconTheme"
    private static let perMetricMenuBarKey = "kMonitor.perMetricMenuBar"
    private static let menuBarOrderKey = "kMonitor.menuBarOrder"
    private static let themeModeKey = "kMonitor.themeMode"
    private static let sparklineThemeIDKey = "kMonitor.sparklineThemeID"
