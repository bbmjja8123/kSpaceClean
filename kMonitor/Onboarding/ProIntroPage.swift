...
/// Third onboarding page: introduce kMonitor Pro without forcing the user
...
struct ProIntroPage: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text(String(localized: "Meet kMonitor Pro")).font(.title2).bold()
            Text(String(localized: "Unlock temperature, fan, and battery readings, 30-day history, threshold alerts, interactive Widget, Live Widgets, and 8 Shortcuts."))
