#!/usr/bin/env python3
"""Generate kMonitor.xcodeproj/project.pbxproj manually — proper OpenStep plist format.

5 targets: kMonitor (app), kMonitorIntents (appex), kMonitorWidget (appex),
kMonitorControlWidget (appex), kMonitorTests (unit test bundle).
...
Note: the previous kMonitorLiveActivity appex target and its ActivityKit sources
were removed in the D2 refactor (Live Activity replaced by WidgetKit
TimelineProvider-based 'Live Widgets'). The macOS deployment target stays at
13.0; Interactive Widget features are gated with @available(macOS 14.0, *) in
the widget code.
"""
...
PROJECT_FILE = f"{BASE}/kMonitor.xcodeproj/project.pbxproj"
...
def main():
    ...
    # ========== Group structure ==========
    root_group_id = add(("PBXGroup", {"name": "kMonitor", "path": "", "sourceTree": "<group>",
                                       "children": []}), "root_group")
    ...
    group_names = [
        ...
        "kMonitorWidget", "kMonitorControlWidget",
    ]
    group_ids = {}
    ...
    # ========== App target sources (all kMonitor sources except widget/test dirs) ==========
    app_files = [
        ...
        ("App/kMonitorApp.swift", "App"),
        ("App/kMonitorAppDelegate.swift", "App"),
        ...
        ("Integrations/KMonitorSpotlightIndexer.swift", "Integrations"),
        ("Intents/ExportDiagnosticsIntent.swift", "Intents"),
        ("Intents/IntentService.swift", "Intents"),
        ("Intents/KMonitorAppShortcuts.swift", "Intents"),
    ...
    widget_files = [
        "kMonitorWidget/WidgetBundle.swift",
        "kMonitorWidget/SystemStatusWidget.swift",
        "kMonitorWidget/WidgetEntry.swift",
        "kMonitorWidget/WidgetSnapshotProvider.swift",
        "kMonitorWidget/WidgetViews.swift",
    ]
    ...
    controlwidget_files = [
        "kMonitorControlWidget/ControlWidget.swift",
        "kMonitorControlWidget/ControlWidgetView.swift",
        "kMonitorControlWidget/ControlWidgetProvider.swift",
        "kMonitorControlWidget/ControlWidgetEntry.swift",
    ]
    ...
    for sf_path in controlwidget_files:
        fname = os.path.basename(sf_path)
        gid = group_ids["kMonitorControlWidget"]
        ref_id = add(make_fileref(fname, sf_path, last="sourcecode.swift"), f"ref_{sf_path}")
        bf_id = add(make_buildfile(ref_id), f"bf_{sf_path}")
        objects[gid][1]["children"].append((ref_id, fname))
    ...
    # test target compile sources. The test target uses `@testable import kMonitor`
    ...
    # Widget Info.plist references (in their respective groups)
    widget_plist_ref = add(make_fileref("Info.plist", "kMonitorWidget/Info.plist",
                                         last="text.plist.xml"), "ref_widget_info_plist")
    objects[group_ids["kMonitorWidget"]][1]["children"].append((widget_plist_ref, "Info.plist"))
    ctrl_plist_ref = add(make_fileref("Info.plist", "kMonitorControlWidget/Info.plist",
                                       last="text.plist.xml"), "ref_ctrl_info_plist")
    objects[group_ids["kMonitorControlWidget"]][1]["children"].append((ctrl_plist_ref, "Info.plist"))
    ...
    # ========== Products ==========
    app_product_id = add(make_fileref("kMonitor.app", "kMonitor.app",
                                        explicit='"wrapper.application"', includeInIndex=0,
                                        sourceTree="BUILT_PRODUCTS_DIR"), "prod_app")
    appex_product_id = add(make_fileref("kMonitorIntents.appex", "kMonitorIntents.appex",
                                          explicit='"wrapper.app-extension"', includeInIndex=0,
                                          sourceTree="BUILT_PRODUCTS_DIR"), "prod_appex")
    widget_product_id = add(make_fileref("kMonitorWidget.appex", "kMonitorWidget.appex",
                                           explicit='"wrapper.app-extension"', includeInIndex=0,
                                           sourceTree="BUILT_PRODUCTS_DIR"), "prod_widget")
    ctrl_product_id = add(make_fileref("kMonitorControlWidget.appex", "kMonitorControlWidget.appex",
                                        explicit='"wrapper.app-extension"', includeInIndex=0,
                                        sourceTree="BUILT_PRODUCTS_DIR"), "prod_ctrl")
    test_product_id = add(make_fileref("kMonitorTests.xctest", "kMonitorTests.xctest",
                                         explicit='"wrapper.cfbundle"', includeInIndex=0,
                                         sourceTree="BUILT_PRODUCTS_DIR"), "prod_test")

    objects[group_ids["Products"]][1]["children"] = [
        (app_product_id, "kMonitor.app"),
        (appex_product_id, "kMonitorIntents.appex"),
        (widget_product_id, "kMonitorWidget.appex"),
        (ctrl_product_id, "kMonitorControlWidget.appex"),
        (test_product_id, "kMonitorTests.xctest"),
    ]
    ...
    # Embed App Extensions phase — copies each .appex into kMonitor.app/Contents/PlugIns/
    # so the system loads them at runtime. Without this, the appex targets build but
    # never reach the bundle, and Widgets / App Intents / Control Widget all silently
    # fail to register with macOS.
    ...
    main_debug_id = make_target_config("Debug", {
        ...
        "INFOPLIST_KEY_CFBundleDisplayName": "kMonitor",
        "INFOPLIST_KEY_CFBundleIdentifier": "app.kraftly.kmonitor",
        "INFOPLIST_KEY_CFBundleName": "kMonitor",
        ...
        "PRODUCT_BUNDLE_IDENTIFIER": "app.kraftly.kmonitor",
    ...
    appex_debug_id = make_target_config("Debug", {
        ...
        "DEVELOPMENT_TEAM": '""',
        "GENERATE_INFOPLIST_FILE": "YES",
        "INFOPLIST_KEY_CFBundleDisplayName": "kMonitorIntents",
        "INFOPLIST_KEY_CFBundleIdentifier": "app.kraftly.kmonitor.intents",
        ...
        "MACOSX_DEPLOYMENT_TARGET": "13.0",
        "MARKETING_VERSION": "1.0",
        "PRODUCT_BUNDLE_IDENTIFIER": "app.kraftly.kmonitor.intents",
        "PRODUCT_NAME": "$(TARGET_NAME)",
        "SDKROOT": "macosx",
        "SWIFT_EMIT_LOC_STRINGS": "YES",
        "SWIFT_VERSION": "5.0",
    ...
    widget_debug_id = make_target_config("Debug", {
        ...
        "DEVELOPMENT_TEAM": '""',
        "GENERATE_INFOPLIST_FILE": "YES",
        "INFOPLIST_FILE": "kMonitorWidget/Info.plist",
        "INFOPLIST_KEY_CFBundleDisplayName": "kMonitorWidget",
        "INFOPLIST_KEY_CFBundleIdentifier": "app.kraftly.kmonitor.widget",
        "INFOPLIST_KEY_CFBundlePackageType": '"XPC!"',
        "INFOPLIST_KEY_CFBundleShortVersionString": '"1.0"',
        "INFOPLIST_KEY_CFBundleVersion": "1",
        ...
        "MACOSX_DEPLOYMENT_TARGET": "13.0",
        "MARKETING_VERSION": "1.0",
        "PRODUCT_BUNDLE_IDENTIFIER": "app.kraftly.kmonitor.widget",
        "PRODUCT_NAME": "$(TARGET_NAME)",
        "SDKROOT": "macosx",
        "SWIFT_EMIT_LOC_STRINGS": "YES",
        "SWIFT_VERSION": "5.0",
    ...
    ctrl_debug_id = make_target_config("Debug", {
        ...
        "DEVELOPMENT_TEAM": '""',
        "GENERATE_INFOPLIST_FILE": "YES",
        "INFOPLIST_FILE": "kMonitorControlWidget/Info.plist",
        "INFOPLIST_KEY_CFBundleDisplayName": "kMonitorControlWidget",
        "INFOPLIST_KEY_CFBundleIdentifier": "app.kraftly.kmonitor.controlwidget",
        "INFOPLIST_KEY_CFBundlePackageType": '"XPC!"',
        "INFOPLIST_KEY_CFBundleShortVersionString": '"1.0"',
        "INFOPLIST_KEY_CFBundleVersion": "1",
        "INFOPLIST_KEY_NSExtensionPointIdentifier": "com.apple.widgetkit-extension",
        ...
        "MACOSX_DEPLOYMENT_TARGET": "13.0",
        "MARKETING_VERSION": "1.0",
        "PRODUCT_BUNDLE_IDENTIFIER": "app.kraftly.kmonitor.controlwidget",
        "PRODUCT_NAME": "$(TARGET_NAME)",
        "SDKROOT": "macosx",
        "SWIFT_EMIT_LOC_STRINGS": "YES",
        "SWIFT_VERSION": "5.0",
    ...
    def make_test_config(name, settings, seed):
        base = {
            ...
            "MACOSX_DEPLOYMENT_TARGET": "13.0",
            "MARKETING_VERSION": "1.0",
            "PRODUCT_BUNDLE_IDENTIFIER": "app.kraftly.kmonitor.tests",
            "PRODUCT_NAME": "$(TARGET_NAME)",
            "SDKROOT": "macosx",
            "SWIFT_VERSION": "5.0",
            "TEST_HOST": '"$(BUILT_PRODUCTS_DIR)/kMonitor.app/Contents/MacOS/kMonitor"',
        }
    ...
    dep_app_intents = make_dep("kMonitorIntents", "target_kMonitorIntents", "cip_app_intents", "dep_app_intents")
    dep_app_widget = make_dep("kMonitorWidget", "target_kMonitorWidget", "cip_app_widget", "dep_app_widget")
    dep_app_ctrl = make_dep("kMonitorControlWidget", "target_kMonitorControlWidget", "cip_app_ctrl", "dep_app_ctrl")
    dep_test_app = make_dep("kMonitor", "target_kMonitor", "cip_test_app", "dep_test_app")
    dep_test_intents = make_dep("kMonitorIntents", "target_kMonitorIntents", "cip_test_intents", "dep_test_intents")
    dep_test_widget = make_dep("kMonitorWidget", "target_kMonitorWidget", "cip_test_widget", "dep_test_widget")
    dep_test_ctrl = make_dep("kMonitorControlWidget", "target_kMonitorControlWidget", "cip_test_ctrl", "dep_test_ctrl")

    # ========== Targets ==========
    main_target_id = add(("PBXNativeTarget", {
        "name": "kMonitor",
        "productName": "kMonitor",
        ...
        "buildRules": [],
        "dependencies": ([(dep_app_intents, "kMonitorIntents"),
                          (dep_app_widget, "kMonitorWidget"),
                          (dep_app_ctrl, "kMonitorControlWidget")] if INCLUDE_APPEX else []),
        "packageProductDependencies": [(prod_metrics_id, "MetricsKit"), (prod_ds_id, "DesignSystem")],
    }), "target_kMonitor")

    if INCLUDE_APPEX:
        appex_target_id = add(("PBXNativeTarget", {
            "name": "kMonitorIntents",
            "productName": "kMonitorIntents",
        ...
        }), "target_kMonitorIntents")

        widget_target_id = add(("PBXNativeTarget", {
            "name": "kMonitorWidget",
            "productName": "kMonitorWidget",
            ...
            "dependencies": [],
            "packageProductDependencies": [(prod_metrics_id, "MetricsKit"), (prod_ds_id, "DesignSystem")],
        }), "target_kMonitorWidget")

        ctrl_target_id = add(("PBXNativeTarget", {
            "name": "kMonitorControlWidget",
            "productName": "kMonitorControlWidget",
            ...
            "dependencies": [],
            "packageProductDependencies": [(prod_metrics_id, "MetricsKit"), (prod_ds_id, "DesignSystem")],
        }), "target_kMonitorControlWidget")

    if INCLUDE_TESTS:
        test_deps = [(dep_test_app, "kMonitor")]
        if INCLUDE_APPEX:
            test_deps.append((dep_test_intents, "kMonitorIntents"))
            test_deps.append((dep_test_widget, "kMonitorWidget"))
            test_deps.append((dep_test_ctrl, "kMonitorControlWidget"))
        test_target_id = add(("PBXNativeTarget", {
            "name": "kMonitorTests",
            "productName": "kMonitorTests",
            ...
            "packageProductDependencies": [(prod_metrics_id, "MetricsKit"), (prod_ds_id, "DesignSystem")],
        }), "target_kMonitorTests")

    # ========== Project ==========
    project_targets = [(main_target_id, "kMonitor")]
    if INCLUDE_APPEX:
        project_targets.append((appex_target_id, "kMonitorIntents"))
        project_targets.append((widget_target_id, "kMonitorWidget"))
        project_targets.append((ctrl_target_id, "kMonitorControlWidget"))
    if INCLUDE_TESTS:
        project_targets.append((test_target_id, "kMonitorTests"))
    ...
    print(f"Target IDs: kMonitor={oid('target_kMonitor')} kMonitorIntents={oid('target_kMonitorIntents')} kMonitorWidget={oid('target_kMonitorWidget')} kMonitorControlWidget={oid('target_kMonitorControlWidget')} kMonitorTests={oid('target_kMonitorTests')}")
