...
/// The window-style content shown when the user clicks the kMonitor status
...
public struct MenuBarView: View {
    ...
    public var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Divider()
            footerActions
            Text("kMonitor v1.0").font(.caption2).foregroundStyle(Color.textSecondary)
        }
        .padding(12)
        .frame(width: 360)
    }
