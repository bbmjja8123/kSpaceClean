...
//  kMonitorWidget
//
//  The kMonitor System Status widget bundle. Hosts `SystemStatusWidget` (and any
...
//       Product Name: kMonitorWidget
//       Bundle ID:    app.kraftly.kmonitor.widget
...
//  4. Delete the auto-generated `kMonitorWidgetBundle.swift` (and any sample
//     `kMonitorWidget.swift`) from the new target and add our
...
@main
struct KMonitorWidgetBundle: WidgetBundle {
