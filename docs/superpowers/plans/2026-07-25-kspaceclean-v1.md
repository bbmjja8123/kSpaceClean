...
- Create: `kSpaceClean/` target skeleton
...
Create `kSpaceClean/kSpaceClean.entitlements`:
...
**Files:**
- Create: `kSpaceClean/Persistence/CoreDataStack.swift`
- Create: `kSpaceClean/Persistence/ScanRecord+CoreData.swift`
- Create: `kSpaceClean/Persistence/FileEntry+CoreData.swift`
- Create: `kSpaceClean/Persistence/CleanupRecord+CoreData.swift`
- Create: `kSpaceClean/Persistence/UserPreferences.swift`
...
In Xcode: Create `kSpaceClean/Persistence/kSpaceClean.xcdatamodeld` with entities:
...
- Create: `kSpaceClean/Features/SmartScan/ScanEngine.swift`
- Create: `kSpaceClean/Features/SmartScan/ScanProgress.swift`
- Create: `kSpaceClean/Features/SmartScan/ScanViewModel.swift`
...
**Files:**
- Create: `kSpaceClean/Features/AIClassifier/AIClassifier.swift`
- Create: `kSpaceClean/Features/AIClassifier/RuleClassifier.swift`
...
// The .mlmodel file lives in kSpaceClean/Resources/Models/
...
**Files:**
- Create: `kSpaceClean/Features/Cleanup/TrashMover.swift`
- Create: `kSpaceClean/Features/Cleanup/CleanupHistory.swift`
- Create: `kSpaceClean/Features/Cleanup/CleanupViewModel.swift`
...
**Files:**
- Create: `kSpaceClean/Features/Onboarding/OnboardingCoordinator.swift`
- Create: `kSpaceClean/Features/Onboarding/OnboardingPages.swift`
...
**Files:**
- Create: `kSpaceClean/App/kSpaceCleanApp.swift`
- Create: `kSpaceClean/App/RootView.swift`
- Create: `kSpaceClean/App/AppState.swift`
- Create: `kSpaceClean/App/AppCoordinator.swift`
- Create: `kSpaceClean/Features/Settings/SettingsView.swift`
...
**Files:**
- Create: `kSpaceClean/Features/DiskGalaxy/GalaxyRenderer.swift`
- Create: `kSpaceClean/Features/DiskGalaxy/GalaxyScene.swift`
- Create: `kSpaceClean/Features/DiskGalaxy/GalaxyViewModel.swift`
- Create: `kSpaceClean/Features/DiskGalaxy/GalaxyView.swift`
...
**Files:**
- Create: `kSpaceClean/Features/RightPanel/RightPanelView.swift`
- Create: `kSpaceClean/Features/RightPanel/OverviewTabView.swift`
- Create: `kSpaceClean/Features/RightPanel/AllFilesTabView.swift`
- Create: `kSpaceClean/Features/RightPanel/SuggestionsTabView.swift`
...
**Files:**
- Create: `kSpaceClean/MenuBar/MenuBarManager.swift`
- Create: `kSpaceClean/MenuBar/DiskStatusView.swift`
...
**Files:**
- Create: `kSpaceClean/Widgets/KSpaceCleanWidget.swift`
- Create: `kSpaceClean/Widgets/WidgetTimelineProvider.swift`
- Modify: `kSpaceClean/Info.plist` (add widget bundle)
...
**Files:**
- Create: `kSpaceClean/Intents/ScanIntent.swift`
- Create: `kSpaceClean/Intents/CleanCacheIntent.swift`
- Create: `kSpaceClean/Intents/ShowLargeFilesIntent.swift`
...
**Files:**
- Create: `kSpaceClean/FinderExtension/FinderSync.swift`
- Create: `kSpaceClean/FinderExtension/Info.plist`
...
**Files:**
- Create: `kSpaceClean/LiveActivity/CleanupActivityAttributes.swift`
...
**Files:**
- Create: `kSpaceClean/Store/StoreManager.swift`
- Create: `kSpaceClean/Store/PaywallView.swift`
...
**Files:**
- Create: `kSpaceClean/Resources/Localizable.xcstrings` (in Xcode: Project → Localizations → add English / Chinese / Japanese)
...
**Files:**
- Create: `kSpaceClean/Spotlight/SpotlightIndexer.swift`
...
**Files:**
- Create: `kSpaceClean/Assets.xcassets/AppIcon.appiconset` (Xcode icon set)
- Modify: `kSpaceClean/Info.plist` (App Store metadata)
