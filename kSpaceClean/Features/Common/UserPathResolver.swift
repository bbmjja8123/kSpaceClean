// kSpaceClean/Features/Common/UserPathResolver.swift
//
...
//
// FDA probing: kSpaceClean ships sandboxed and requires the user to grant
...
enum UserPathResolver {
    ...
    /// True when the user has granted Full Disk Access to kSpaceClean.
    ///
