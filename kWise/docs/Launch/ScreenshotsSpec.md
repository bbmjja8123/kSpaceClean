...
## File Locations
Save final PNGs in `kWise/docs/Launch/Screenshots/` (one folder per locale):
- `kWise/docs/Launch/Screenshots/en-US/`
- `kWise/docs/Launch/Screenshots/zh-CN/` (overlay text translated)
- `kWise/docs/Launch/Screenshots/ja/` (overlay text translated)